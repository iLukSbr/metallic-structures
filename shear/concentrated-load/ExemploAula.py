...
tipo_cima = 'compressao'
#Carga característica
Fcima = 315 #kN
#Menor distância do apoio
lap_cima = L/4 #cm
#Majoração
gamma_cima = 1.2 #CARGA TRUNCADA
#Carga de cálculo
Fcima_d = gamma_cima*Fcima #kN
#Região de aplicação
bforca_cima = 30.5 #cm
lforca_cima = 124.5 #cm
#Rotação da mesa
rotac_cima = 'livre'
#Comprimento destravado
Lb_cima = L #cm
#Momento solicitante de cálculo
Msd_cima = Fcima_d*lap_cima*(L-lap_cima)/L #kN.cm VIGA TIPO 6
...
lap_baixo = L/4 #cm
#Majoração
gamma_baixo = 1.5 #CARGA DE USO
#Carga de cálculo
Fbaixo_d = gamma_baixo*Fbaixo #kN
#Região de aplicação
bforca_baixo = 30.5 #cm
lforca_baixo = 124.5 #cm
#Rotação da mesa
rotac_baixo = 'livre'
#Comprimento destravado
Lb_baixo = L #cm
#Momento solicitante de cálculo
Msd_baixo = Fbaixo_d*lap_baixo*(L-lap_baixo)/L #kN.cm VIGA TIPO 6
