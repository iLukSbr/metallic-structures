...
#Propriedades do aço:
E = 20000 #kN/cm²
fy = 25 #kN/cm² TIPO MR250
gamma_a1 = 1.1

#Propriedades do perfil:
#PERFIL CVS 400 x 125
d = 40 #cm
tw = 1.25 #cm
h = 36.2 #cm
tf = 1.9 #cm
...
lap_cima = 142.5 #cm
#Majoração
gamma_cima = 1.3 #PESO PRÓPRIO DE ESTRUTURA PRÉ-MOLDADA
#Carga de cálculo
Fcima_d = gamma_cima*Fcima #kN
#Região de aplicação
bforca_cima = 20.45 #cm
lforca_cima = 20.44 #cm
#Rotação da mesa
rotac_cima = 'livre'
#Comprimento destravado
Lb_cima = L #cm
#Momento solicitante de cálculo
Msd_cima = Fcima_d*(L - lap_cima)*lap_cima/L #kN.cm VIGA TIPO 6
