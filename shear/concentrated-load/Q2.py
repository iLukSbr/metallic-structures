...
#Região de aplicação
bforca_cima = 4.16 #cm
lforca_cima = 18.13  #cm
#Rotação da mesa
rotac_cima = 'livre'
#Comprimento destravado
Lb_cima = L #cm
#Momento solicitante de cálculo
R1 = Fcima_d*(((L - lap_cima)**2)/L**3)*(3*lap_cima + (L - lap_cima))
Msd_cima = -Fcima_d*lap_cima*(L - lap_cima)**2/L**2 + R1*lap_cima #kN.cm VIGA TIPO 13
