...
perfil = input('Qual o tipo da área efetiva de cisalhamento? ')
...
V_Sd = 0
tem_carga_solic = input('Tem carga solicitante? [s/n] ')
...
enrij = input('A alma terá enrijecedores transversais? [s/n] ')
