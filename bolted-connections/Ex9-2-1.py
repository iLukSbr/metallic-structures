...
#Resistência última
fub = 40 #kN/cm² parafuso tipo ISO 891-1 CLASSE 4.6
gamma_a2 = 1.35
...
lf_interno = 6.985 - dfe #cm VER DESENHO
#Fissuração total
...
#Chapa tipo 1
    ...
    if Fcrd1 >= Fsd:
        print('Fcrd=',Fcrd1,'>= Fsd=',Fsd,'resiste ao rasgamento!')
    else:
        print('Fcrd=',Fcrd1,'< Fsd=',Fsd,'NÃO resiste ao rasgamento!')
    print(' ')
#Chapa tipo 2
    if n_chapas2 > 0:
        print('Chapa tipo 2:')
        ...
        if Fcrd2 >= Fsd:
            print('Fcrd=',Fcrd2,'>= Fsd=',Fsd,'resiste ao rasgamento!')
        else:
            print('Fcrd=',Fcrd2,'< Fsd=',Fsd,'NÃO resiste ao rasgamento!')
        print(' ')
