...
Fq = 720 #kN variável
gamma_g = 0 #CARGA DE 
gamma_q = 1 #CARGA DE USO EXCEPCIONAL
...
lf_borda = 3.8 - dfe/2 #cm VER DESENHO
#Distância reta da borda de um furo à borda de outro furo
lf_interno = 5.7 - dfe #cm VER DESENHO
#Fissuração total
lf = 2*(4*lf_interno + lf_borda)
